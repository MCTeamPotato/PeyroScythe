...
public class NewMagicSwordItem extends NewExtendedSwordItem implements IPresetSpellContainer {
    private List<SpellData> spellData = null;
    private SpellDataRegistryHolder[] spellDataRegistryHolders;

    public NewMagicSwordItem(Tier tier, double attackDamage, double attackSpeed,
