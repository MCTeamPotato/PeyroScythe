...
/*
    ...
    public static Holder.Reference<SoundEvent> registerForHolder(ResourceLocation name) {
    ...
    public static ImmutableList<Holder.Reference<SoundEvent>> registerGoatHornSoundVariants() {
