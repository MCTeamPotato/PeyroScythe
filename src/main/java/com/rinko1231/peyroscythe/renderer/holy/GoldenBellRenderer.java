...
public class GoldenBellRenderer extends EntityRenderer<GoldenBellEntity> {
    ...
    public static final Material BELL_MATERIAL = new Material(TextureAtlas.LOCATION_BLOCKS, ResourceLocation.fromNamespaceAndPath("minecraft","entity/bell/bell_body"));
...
// 组装成 ARGB
        int color = (a << 24) | (ri << 16) | (gi << 8) | bi;

// 调用新版 render
        this.bellBody.render(poseStack, vc, packedLight, OverlayTexture.NO_OVERLAY, color);
        poseStack.popPose();
