...
public class HolyLanceRenderer extends EntityRenderer<HolyLanceProjectile> {
    ...
    public static void renderModel(PoseStack poseStack, MultiBufferSource bufferSource, int animOffset) {
        ...
        consumer. addVertex(poseMatrix, 0.0F, -halfWidth, -halfHeight).setColor(255, 255, 255, 255).setUv(0.0F, 1.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(0.0F, 1.0F, 0.0F);
        consumer. addVertex(poseMatrix, 0.0F, halfWidth, -halfHeight).setColor(255, 255, 255, 255).setUv(0.0F, 0.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(0.0F, 1.0F, 0.0F);
        consumer. addVertex(poseMatrix, 0.0F, halfWidth, halfHeight).setColor(255, 255, 255, 255).setUv(1.0F, 0.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(0.0F, 1.0F, 0.0F);
        consumer. addVertex(poseMatrix, 0.0F, -halfWidth, halfHeight).setColor(255, 255, 255, 255).setUv(1.0F, 1.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(0.0F, 1.0F, 0.0F);
        poseStack.mulPose(Axis.XP.rotationDegrees(-angleCorrection));
        poseStack.mulPose(Axis.YP.rotationDegrees(-angleCorrection));
        consumer. addVertex(poseMatrix, -halfWidth, 0.0F, -halfHeight).setColor(255, 255, 255, 255).setUv(0.0F, 1.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(0.0F, 1.0F, 0.0F);
        consumer. addVertex(poseMatrix, halfWidth, 0.0F, -halfHeight).setColor(255, 255, 255, 255).setUv(0.0F, 0.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(0.0F, 1.0F, 0.0F);
        consumer. addVertex(poseMatrix, halfWidth, 0.0F, halfHeight).setColor(255, 255, 255, 255).setUv(1.0F, 0.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(0.0F, 1.0F, 0.0F);
        consumer. addVertex(poseMatrix, -halfWidth, 0.0F, halfHeight).setColor(255, 255, 255, 255).setUv(1.0F, 1.0F).setOverlay(OverlayTexture.NO_OVERLAY).setLight(15728880).setNormal(0.0F, 1.0F, 0.0F);
        poseStack.mulPose(Axis.YP.rotationDegrees(angleCorrection));
    }
