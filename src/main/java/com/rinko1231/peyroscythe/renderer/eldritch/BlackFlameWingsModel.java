...
@OnlyIn(Dist.CLIENT)
public class BlackFlameWingsModel<T extends LivingEntity> extends AgeableListModel<T> {
        private final ModelPart rightWing;
        private final ModelPart leftWing;
        public static final String MAIN = "main";
        public static final String BLACK_FLAME_WINGS = "black_flame_wings";
        public static ModelLayerLocation BLACK_FLAME_WINGS_LAYER = new ModelLayerLocation(PeyroScythe.id( "black_flame_wings"), "main");

        public BlackFlameWingsModel(ModelPart pRoot) {
