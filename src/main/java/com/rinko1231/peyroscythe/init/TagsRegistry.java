...
public class TagsRegistry {
    ...
    public static final TagKey<EntityType<?>> ILLUSION_IMMUNE;
    ...
    static {
        CURIOS_DROP = TagKey.create(Registries.ENTITY_TYPE, PeyroScythe.id( "curios_drop"));
        DEATH_SMOKE_IMMUNE = TagKey.create(Registries.ENTITY_TYPE, PeyroScythe.id( "death_smoke_immune"));
        MUST_FREEZE_BOSS = TagKey.create(Registries.ENTITY_TYPE, PeyroScythe.id("must_freeze_boss"));
        ...
        ILLUSION_IMMUNE = TagKey.create(Registries.ENTITY_TYPE, PeyroScythe.id( "illusion_immune"));
     }
    ...
    private static TagKey<DamageType> create(String tag) {
        return TagKey.create(Registries.DAMAGE_TYPE, PeyroScythe.id( tag));
    }
}
