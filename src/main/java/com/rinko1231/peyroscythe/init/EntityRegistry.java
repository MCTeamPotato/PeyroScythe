...
public class EntityRegistry {
    public static final DeferredRegister<EntityType<?>> ENTITIES =
            DeferredRegister.create(Registries.ENTITY_TYPE, "peyroscythe");

    public static final DeferredHolder<EntityType<?>, EntityType<IceQuakeAoe>> ICE_QUAKE_AOE =
            ENTITIES.register("ice_quake",
                    () -> EntityType.Builder.<IceQuakeAoe>of(IceQuakeAoe::new, MobCategory.MISC)
                            .sized(4.0F, 0.8F)
                            .setTrackingRange(64)
                            .build(PeyroScythe.id("ice_quake").toString())
            );
    // 冰川术冰块弹体注册
    public static final DeferredHolder<EntityType<?>, EntityType<GlacierIceBlockProjectile>> GLACIER_ICE_BLOCK_PROJECTILE =
            ENTITIES.register("glacier_ice_block_projectile",
                    () -> EntityType.Builder.<GlacierIceBlockProjectile>of(GlacierIceBlockProjectile::new, MobCategory.MISC)
                            ...
                            .setTrackingRange(64)
                            .setUpdateInterval(1)
                            .build(PeyroScythe.id(
                                    "glacier_ice_block_projectile").toString())
            );
    public static final DeferredHolder<EntityType<?>, EntityType<DeathSmokeProjectile>> DEATH_SMOKE_PROJECTILE =
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<CrimsonMoon>> CRIMSON_MOON =
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<GoldenBellEntity>> GOLDEN_BELL =
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<IcyCometEntity>> ICY_COMET =
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<FrostFogEntity>> FROST_FOG =
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<AbyssMudEntity>> ABYSS_MUD =
    ...
    /*
    public static final DeferredHolder<EntityType<?>, EntityType<MundusEntity>> MUNDUS =
            ENTITIES.register("mundus",
                    () -> EntityType.Builder.<MundusEntity>of(MundusEntity::new, MobCategory.MISC)
                            ...
                            .build((PeyroScythe.id(
                                    "mundus")).toString()));
    */
    public static final DeferredHolder<EntityType<?>, EntityType<HolyLanceProjectile>> HOLY_LANCE_PROJECTILE =
    ...
    /*
    public static final DeferredHolder<EntityType<?>, EntityType<TempestEdgeProjectile>> TEMPEST_EDGE_PROJECTILE =
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<TempestEdgeHProjectile>> TEMPEST_EDGE_H_PROJECTILE =
...
*/
    public static final DeferredHolder<EntityType<?>, EntityType<NeroHolyRayVisualEntity>> NERO_HOLY_RAY_VISUAL_ENTITY =
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<SummonedBlaze>> SUMMONED_BLAZE =
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<BlackFireball>> BLACK_FIREBALL =
            ENTITIES.register("black_fireball",
                    () -> EntityType.Builder.<BlackFireball>of(BlackFireball::new, MobCategory.MISC)
                            .sized(1.0F, 1.0F)
                            .clientTrackingRange(8)
                            .build((PeyroScythe.id("black_fireball")).toString()));

    public static final DeferredHolder<EntityType<?>, EntityType<BlackFireballSmall>>BLACK_FIREBALL_SMALL =
            ENTITIES.register("black_fireball_small",
                    () -> EntityType.Builder.<BlackFireballSmall>of(BlackFireballSmall::new, MobCategory.MISC)
                            .sized(0.5F, 0.5F)
                            .clientTrackingRange(4)
                            .build((PeyroScythe.id("black_fireball_small")).toString()));


    public static final DeferredHolder<EntityType<?>, EntityType<MadeInHeavenProjectile>> MADE_IN_HEAVEN_PROJECTILE =
    ...
    public static final DeferredHolder<EntityType<?>, EntityType<MadeInHeavenRealProjectile>> MADE_IN_HEAVEN_REAL_PROJECTILE =
